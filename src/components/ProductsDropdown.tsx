...
const ProductsDropdown: React.FC<ProductsDropdownProps> = ({ 
  ...
  // English Language Courses - быстрый доступ к основным категориям
  const categories = [
    { id: 1, name: 'Course Introduction', icon: '📖', productId: 1 },
    { id: 2, name: 'Writing Basics', icon: '✍️', productId: 2 },
    { id: 3, name: 'Grammar Fundamentals', icon: '📝', productId: 4 },
    { id: 4, name: 'Advanced Grammar', icon: '🎤', productId: 8 },
    { id: 5, name: 'Complete Mastery', icon: '🎓', productId: 16 }
  ];
  
  // Показываем только 2 курса английского для компактности
  ...
  return (
    ...
    >
      <DropdownContent>
        ...
        <FeaturedSection>
          <FeaturedTitle>Featured English Language Courses</FeaturedTitle>
          <ProductGrid>
