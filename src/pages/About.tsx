  ...
  return (
    <AboutWrapper>
      <HeroSection ref={heroRef}>
        ...
        <LogoContainer>
          <MainLogo>ENGLISH E-COURSES</MainLogo>
        </LogoContainer>
        ...
        <Container>
          <ContentContainer>
            <CompanyName ref={setElementRef(0)}>
              {splitTextToLetters('ENGLISH E-COURSES')}
            </CompanyName>
            
            <MissionText ref={setElementRef(1)}>
              {splitTextToWords('To empower students worldwide with professional English language education,')}
            </MissionText>
            
            <MissionText ref={setElementRef(2)}>
              {splitTextToWords('providing comprehensive courses that transform basic writing and grammar concepts into fluent communication skills.')}
            </MissionText>
            
            <DescriptionText ref={setElementRef(3)} className="description-text">
              {splitTextToChars('Our expertly crafted English language courses cover writing fundamentals, grammar essentials, sentence structure, paragraph formation, punctuation rules, and advanced composition skills. Each course is designed with practical exercises, real-world applications, and professional techniques to help you master English writing and transform your communication abilities for academic and career success.')}
            </DescriptionText>
            
            <ProductsCallToAction ref={setElementRef(4)}>
              <ProductsCard to="/products">
                <ProductsCardTitle>Explore Our English Language Courses</ProductsCardTitle>
                <ProductsCardDescription>
                  Discover comprehensive English writing and grammar learning programs designed for all skill levels
                </ProductsCardDescription>
                <ProductsCardButton>
                  View Courses
                </ProductsCardButton>
          ...
          <LeadershipContainer>
            ...
            <LeadershipGrid>
              <ClickableLeaderCard ref={setElementRef(6)} onClick={openModal}>
                ...
                <LeaderInfo>
                  <LeaderName>Language Expert</LeaderName>
                  <LeaderTitle>English Language Experts & Educators</LeaderTitle>
                  <LeaderDescription>
                    Passionate about English language education and dedicated to making writing and grammar instruction accessible to everyone. 
                    Creates comprehensive video courses to help others learn and master the fundamentals of English writing and communication.
                  </LeaderDescription>
                </LeaderInfo>
              </ClickableLeaderCard>
            </LeadershipGrid>
          ...
          <ValuesContainer>
            ...
            <ValuesGrid>
              <ValueCard ref={setElementRef(28)}>
                <ValueIcon>🎯</ValueIcon>
                <ValueTitle>Excellence in English Language Education</ValueTitle>
                <ValueDescription>
                  We maintain the highest standards in English language education, constantly updating 
                  our curriculum with the latest writing techniques and grammar best practices.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(29)}>
                ...
                <ValueDescription>
                  English learning should be accessible to everyone. We create a supportive environment 
                  where students from all backgrounds can master English writing fundamentals.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(30)}>
                <ValueIcon>⚡</ValueIcon>
                <ValueTitle>Modern Teaching Techniques</ValueTitle>
                <ValueDescription>
                  We stay current with the latest language teaching methods and tools, 
                  bringing modern English instruction practices directly to our students.
                </ValueDescription>
              </ValueCard>

              <ValueCard ref={setElementRef(31)}>
                <ValueIcon>🛡️</ValueIcon>
                <ValueTitle>Professional Communication Standards</ValueTitle>
                <ValueDescription>
                  We prioritize creating clear, effective communication skills, teaching not just how to 
                  write correctly, but how to communicate efficiently and professionally.
                </ValueDescription>
              </ValueCard>
              ...
              <ValueCard ref={setElementRef(32)}>
                ...
                <ValueDescription>
                  English language learning is an evolving journey. We foster continuous learning 
              ...
              <ValueCard ref={setElementRef(33)}>
                ...
                <ValueDescription>
                  We focus on practical English writing skills that you can apply immediately 
                  in your studies, from essays to professional emails and academic papers.
                </ValueDescription>
              </ValueCard>
            </ValuesGrid>
            ...
            <MissionStatement ref={setElementRef(34)}>
              ...
              <MissionStatementText>
                To empower the next generation of students with world-class English language education, 
                practical skills, and real-world writing techniques that drive academic and career success. 
                We believe that by making English language education accessible and excellent, we can help 
                students develop strong communication skills while creating opportunities for everyone 
      ...
      <ModalOverlay isOpen={isModalOpen} onClick={closeModal}>
        <ModalContent isOpen={isModalOpen} onClick={(e) => e.stopPropagation()}>
          ...
          <ModalHeader>
            ...
            <ModalSubtitle>English Language Education Experts</ModalSubtitle>
          </ModalHeader>

          <ModalDescription>
            Our team of professional English language experts is dedicated to 
            transforming communication skills through comprehensive writing and grammar education.
            <br /><br />
            We believe English language learning should be accessible to everyone, from complete beginners to advanced students looking to 
            refine their skills. That's why we created comprehensive video courses that break down complex writing and grammar concepts 
            into understandable, practical lessons.
            <br /><br />
            Our mission is simple: to help others discover the amazing world of English language and empower them 
            with the knowledge and skills needed to write effectively and communicate clearly. Every course we create is designed with 
            real-world applications in mind, ensuring you can apply what you learn immediately in your studies and career.
            <br /><br />
            Whether you're just starting your English learning journey or looking to master advanced writing techniques, 
            our expert team is here to guide you every step of the way. Let's explore the incredible possibilities of professional English communication together!
          </ModalDescription>
        </ModalContent>
      </ModalOverlay>
    </AboutWrapper>
