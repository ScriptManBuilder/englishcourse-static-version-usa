...
const Account: React.FC = () => {
  ...
  const renderCoursesSection = () => {
    ...
    if (!isTestAccount) {
      return (
        <div>
          <SectionTitle>MY ENGLISH LANGUAGE COURSES</SectionTitle>
          
          <InfoCard>
            <EmptyOrdersText>
              🎓 Your purchased ENGLISH LANGUAGE courses will appear here after successful payment.
            </EmptyOrdersText>
            <EmptyOrdersText style={{ fontSize: '1rem', marginTop: '1rem', opacity: 0.8 }}>
              Once you purchase any English Language course, you'll have lifetime access to all course materials, 
              including videos, downloadable resources, and future updates.
            </EmptyOrdersText>
            <EmptyOrdersButtonWrapper>
              <ShoppingButton as={Link} to="/products" variant="primary">
                Browse English Language Courses
              </ShoppingButton>
            </EmptyOrdersButtonWrapper>
          </InfoCard>
        </div>
    ...
    return (
      <div>
        <div style={{
          ...
          {isSmallMobile ? 'MY ENGLISH COURSES' : 'MY ENGLISH LANGUAGE COURSES'}
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            textAlign: isSmallMobile ? 'center' : 'left'
          }}>{isSmallMobile ? 'Continue your English learning journey' : 'Continue your English Language mastery journey'}</p>
          <div style={{ 
            display: 'flex', 
          ...
          {isMobile && (
            <div style={{
              ...
              <div style={{
                ...
                >
                  📚 {isSmallMobile ? 'My Courses' : 'My English Language Courses'}
                </button>
