...
const Home: React.FC = () => {
  ...
  const carouselSlides = [
    {
      title: "Why Choose English E-Courses?",
      subtitle: "Discover the excellence that makes our English language education exceptional"
    },
    {
      title: "Expert-Led English Training",
      subtitle: "Learn from professional teachers with real-world English teaching and communication experience"
    },
    {
      title: "Innovation Meets Tradition",
      subtitle: "Where cutting-edge English learning techniques meet timeless language wisdom"
    }
  ];
  ...
  const featuredSlides = [
    {
      title: "Featured English Language Courses",
      subtitle: "Discover our most popular and effective English language training programs"
    },
    {
      title: "Revolutionary English Learning",
      subtitle: "Next-generation English language education that transforms your learning journey"
    },
    {
      title: "Premium Language Education",
      subtitle: "Crafted for those who demand excellence in English language mastery"
    }
  ];

  // Мемоизируем массив изображений для галереи
  const galleryImages = useMemo(() => {
    // Новые English learning изображения для галереи
    const allImages = [
      { src: `/images/img_1.jpg`, alt: `English Learning Portfolio 1`, type: 'english-portfolio' },
      { src: `/images/img_2.jpg`, alt: `Language Skills Portfolio 2`, type: 'english-portfolio' },
      { src: `/images/img_3.jpg`, alt: `English Education Portfolio 3`, type: 'english-portfolio' },
      { src: `/images/img_4.jpg`, alt: `Language Learning Portfolio 4`, type: 'english-portfolio' },
      { src: `/images/img_5.jpg`, alt: `English Courses Portfolio 5`, type: 'english-portfolio' },
      { src: `/images/img_6.jpg`, alt: `Language Training Portfolio 6`, type: 'english-portfolio' },
      { src: `/images/img_7.jpg`, alt: `English Skills Portfolio 7`, type: 'english-portfolio' },
      { src: `/images/img_8.jpg`, alt: `Language Mastery Portfolio 8`, type: 'english-portfolio' }
    ];
  ...
  const scrollingTexts = useMemo(() => [
    'MASTER ENGLISH LANGUAGE TODAY',
    'FOLLOW US @ENGLISH_ECOURSES',
    'PREMIUM ENGLISH LANGUAGE COURSES',
    'TRANSFORM YOUR LANGUAGE SKILLS',
    'GRAMMAR & VOCABULARY',
    'JOIN THE ENGLISH LEARNING REVOLUTION NOW'
  ], []);  useEffect(() => {
  ...
  return (
    <>
      <HeroSection>
        ...
        <Container>
          <HeroContent>
            <HeroTitle>ENGLISH E-COURSES</HeroTitle>
            <HeroSubtitle>
              Master English Language Skills with Expert-Led Video Courses - Transform Your Communication Today
            </HeroSubtitle>
            <HeroButtons>
        ...
        <Container>
          ...
          <FeaturesGrid>
            <ScrollReveal ref={setScrollRevealRef(1)} delay={100}>
              <FeatureCard>
                <RocketIcon />
                <FeatureTitle>Expert Teacher Instruction</FeatureTitle>
                <FeatureDescription>
                  Learn from professional English teachers with hands-on teaching experience and proven track records.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(2)} delay={200}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Start learning immediately with lifetime access to all course materials and lesson updates.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(3)} delay={300}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Industry-recognized certificates and rigorous language curriculum ensure professional standards.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(4)} delay={400}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Join hundreds of English learning enthusiasts worldwide with 24/7 support and community access.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(5)} delay={500}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Real-world conversations and language projects that you can apply immediately in daily life.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
            ...
            <ScrollReveal ref={setScrollRevealRef(6)} delay={600}>
              <FeatureCard>
                ...
                <FeatureDescription>
                  Cutting-edge English lessons updated regularly with the latest language learning developments and trends.
                </FeatureDescription>
              </FeatureCard>
            </ScrollReveal>
          </FeaturesGrid>
      ...
      <VideoSection ref={videoSectionRef}>
        ...
        <VideoSectionContent>
          <VideoSectionTitle>English Learning in Action</VideoSectionTitle>
          <VideoSectionSubtitle>
            Experience the future of language learning through interactive lessons and real-world communication applications
          </VideoSectionSubtitle>
        </VideoSectionContent>
      </VideoSection>
      ...
      <InfoSection>
        <InfoGrid>
          <InfoBlock>
            <InfoTitle>Master English Language</InfoTitle>
            <InfoDescription>
              Transform your language skills with comprehensive English language training. 
              Learn grammar, vocabulary, pronunciation, and advanced communication techniques 
              that professional speakers use to communicate effectively in English.
            </InfoDescription>
            
            <InfoSubsection>
              <InfoSubtitle>Professional Language Development</InfoSubtitle>
              <InfoText>
                Master <InfoHighlight>advanced English language techniques </InfoHighlight> 
                 that deliver fluent, natural communication. From basic grammar to 
                advanced conversation, learn to communicate with native-level proficiency.
              </InfoText>
            </InfoSubsection>
          </InfoBlock>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              Apply language knowledge immediately with practical conversations and dialogues. 
              Our courses focus on real-life scenarios and measurable improvement in your English language skills.
            </InfoDescription>
            
            <InfoSubsection>
              <InfoSubtitle>Industry-Proven Methods</InfoSubtitle>
              <InfoText>
                Learn <InfoHighlight>battle-tested English learning strategies</InfoHighlight> used by 
                top teachers and language professionals. From vocabulary building to fluent communication, 
                master techniques that deliver impressive results.
              </InfoText>
            </InfoSubsection>
          </InfoBlock>
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              Enjoy unlimited access to all course materials, updates, and new lessons. 
              Stay ahead of the rapidly evolving English language learning industry with continuous learning.
            </InfoDescription>
            ...
            <InfoSubsection>
              ...
              <InfoText>
                ...
                evolves with English language trends. New lessons, vocabulary, and grammar information are 
          ...
          <InfoBlock>
            ...
            <InfoDescription>
              Join a thriving community of English learning enthusiasts and receive personalized guidance. 
              Get answers to your questions and accelerate your English language learning journey.
            </InfoDescription>
            
            <InfoSubsection>
              <InfoSubtitle>24/7 Community Access</InfoSubtitle>
              <InfoText>
                Connect with <InfoHighlight>hundreds of English language learners worldwide </InfoHighlight> 
                through our exclusive community platform. Share experiences, get feedback, 
                and collaborate on English learning projects.
              </InfoText>
            </InfoSubsection>
          </InfoBlock>
        </InfoGrid>
