...
const Products: React.FC = () => {
  ...
  const categories = useMemo(() => [
    ...
    { id: 'Writing Basics', name: 'Writing Basics' },
    { id: 'Writing Structure', name: 'Writing Structure' },
 
    { id: 'Writing Skills', name: 'Writing Skills' },
    { id: 'Grammar Skills', name: 'Grammar Skills' },
  ...
  return (
    <ProductsWrapper>
      <Container>
        <PageHeader>
          <PageTitle>English Language Mastery Collection</PageTitle>
          <PageSubtitle>Master English writing and grammar skills with our comprehensive university-level video courses</PageSubtitle>
        </PageHeader>
