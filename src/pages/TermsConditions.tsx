    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital English Language courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This English Language course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital English Language Course Pricing</SectionTitle>
        <Paragraph>
          Our English Language courses are available at the following price points: {formatPrice(1.95)}, {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, {formatPrice(99.99)}, {formatPrice(109)}, {formatPrice(119)}, {formatPrice(129)}, and {formatPrice(139)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for English Language course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "ENGLISH E-COURSES" or "ENGLISH-ECOURSES.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased English Language courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All English Language course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our English Language courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our English Language course content to reflect the latest developments in language teaching techniques. 
